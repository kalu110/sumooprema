    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" onsubmit="return validationPass()">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <label id="errorPassConf" style="color:red; opacity:0.6;" ></label>
                            </div>
                        </div>
...
<script>
    function validationPass(){
        ...
        let pass2 = document.querySelector('#password_confirm').value;
        let html = document.querySelector('#errorPassConf');
        
        if(pass != pass2){
            html.innerHTML='Lozinke moraju da se poklapaju!';
        }
    }
</script>
