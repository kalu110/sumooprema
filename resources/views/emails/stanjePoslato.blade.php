    ...
    <div class="container">
        <div class="row">
           ...
           <div>
            ...
            <div class="row">
                <div class="col-md-8 col-12"> <p>Porudžbina je predata kurirskoj službi i nadamo se da će paket stići do Vas u najkraćem mogućem roku!</p>
            <p><i class="fa-solid fa-truck fa-xl"></i></p></div>
