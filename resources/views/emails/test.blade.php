...
<body>
    <div class="container">
        <div class="row">
           ...
           <div>
            <h3 class="text-center">Čestitamo {{$name}}!</h3>
            <div class="row">
                <div class="col-md-8 col-12"> <p>Porudžbina je uspešno poslata!</p>
            <p>O daljem toku porudzbine bicete naknadno obavesteni putem mejla ili telefonskog poziva!</p></div>
